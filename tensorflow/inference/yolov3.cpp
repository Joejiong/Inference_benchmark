...
int main(int argc, char const *argv[]) {
  const std::string graph_fn = "./frozen_models/yolov3.pb";
  ...
  // prepare inputs
  tensorflow::TensorShape data_shape({32, 224, 224, 3});
  ...
  const std::string output_name = "detector/yolo-v3/detections";
