...
class BasicLSTM(nn.Module):
    ...
    def forward(self, input, last_hidden, last_cell):
        ...
        pre_hidden, pre_cell = last_hidden, last_cell
        ...
        def step( step_in, pre_hidden, pre_cell, layers_index):
            print("step_in----------",step_in.shape)
            print("pre_hidden-----------",pre_hidden.shape)
...
class RNNModel(nn.Module):
    ...
    def forward(self, input, last_hidden, last_cell):
        ...
        output, last_hidden, last_cell = self.rnn(emb, last_hidden, last_cell)
        decoded = self.decoder(output.view(output.size(0)*output.size(1), output.size(2)))
        return decoded.view(output.size(0), output.size(1), decoded.size(1)), last_hidden, last_cell
